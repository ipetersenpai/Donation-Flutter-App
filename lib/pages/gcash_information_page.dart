...
class GcashInformationPage extends StatefulWidget {
  final String? paymentMethod;
  final String donationId;
  final String amount;

  const GcashInformationPage({
    super.key,
  ...
  _GcashInformationPageState createState() => _GcashInformationPageState();
}

class _GcashInformationPageState extends State<GcashInformationPage> {
