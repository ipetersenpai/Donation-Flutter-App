...
class MayaInformationPage extends StatefulWidget {
  final String? paymentMethod;
  final String donationId;
  final String amount;

  const MayaInformationPage({
    super.key,
  ...
  _MayaInformationPageState createState() => _MayaInformationPageState();
}

class _MayaInformationPageState extends State<MayaInformationPage> {
